...
<div id="wrap">
	...
	<div id="logoWrap">
	<div id="logo">
		<img alt="" src="images/logo_green.png" style="width: 200px"/>
	</div>
	</div>
	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="#">
						<img alt="" src="images/vegitable.png" style="width: 20px; margin-right: 5px"/>채소
					</a>
					<a class="dropdown-item" href="#">
						<img alt="" src="images/fruit.png" style="width: 20px; margin-right: 5px"/>과일
					</a>
					<a class="dropdown-item" href="#">
						<img alt="" src="images/meat.png" style="width: 20px; margin-right: 5px"/>정육/계란
					</a>
					<a class="dropdown-item" href="#">
						<img alt="" src="images/bread.png" style="width: 20px; margin-right: 5px"/>베이커리
					</a>
					<a class="dropdown-item" href="#">
						<img alt="" src="images/dairy.png" style="width: 20px; margin-right: 5px"/>유제품
					</a>
				</div>
				</li>
			</ul>
			<form class="form-inline my-2 my-lg-0">
				...
				<img alt="" src="images/search.png" style="width: 30px; margin-right: 50px">
	...
	<div id="mainImg" class="carousel slide" data-ride="carousel">
	  <div class="carousel-inner">
	    <div class="carousel-item active" data-interval="3000">
	      <img src="images/main_img1.jpg" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item" data-interval="3000">
	      <img src="images/main_img2.jpg" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item" data-interval="3000">
	      <img src="images/main_img3.jpg" class="d-block w-100" alt="...">
	    </div>
	  </div>
	...
	<div id="containerContent">
		<div class="card" style="width: 18rem; margin: 20px 10px 20px 10px; ">
			<img src="images/item_img1.png" class="card-img-top" alt="...">
			<div class="card-body">
		...
		<div class="card" style="width: 18rem; margin: 20px 10px 20px 10px;; ">
			<img src="images/item_img2.png" class="card-img-top" alt="...">
			<div class="card-body">
		...
		<div class="card" style="width: 18rem; margin: 20px 10px 20px 10px; ">
			<img src="images/item_img3.png" class="card-img-top" alt="...">
			<div class="card-body">
		...
		<div class="card" style="width: 18rem; margin: 20px 10px 20px 10px; ">
			<img src="images/item_img4.png" class="card-img-top" alt="...">
			<div class="card-body">
	...
	<img alt="" src="images/main_img4.jpg" style="width: 100%">
	</div>
	</div>
	...
	<img alt="" src="images/footer.jpg"  style="width: 100%">
	</div>
	</div>
</div>
